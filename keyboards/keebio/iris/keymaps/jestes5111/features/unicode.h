...
#define E_GRAVE UP(_E_GRAVE_LOWER, _E_GRAVE_UPPER)
#define I_GRAVE UP(_I_GRAVE_LOWER, _I_GRAVE_UPPER)
#define O_GRAVE UP(_O_GRAVE_LOWER, _O_GRAVE_UPPER)
#define U_GRAVE UP(_U_GRAVE_LOWER, _U_GRAVE_UPPER)
